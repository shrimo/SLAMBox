...
- [GC-RANSAC](https://arxiv.org/abs/1706.03437) (Graph-Cut RANSAC) — a locally optimized RANSAC variant that uses graph-cut algorithm to refine the inlier set within each iteration, enforcing spatial consistency among neighboring points to produce more accurate and stable model estimates.
