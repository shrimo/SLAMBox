            ...
            if self.show_mask:
                ...
                for i in indices:
                    ...
                    if label in self.inclusion_list:
                        cv2.rectangle(clean_plate, (x-10, y-10),(x + w + 10, y + h + 10), (0, 0, 0), -1)
                return clean_plate
                ...
                for i in indices:
                    ...
                    cv2.rectangle(frame, (x, y), (x+width_label, y+20), color_rec, -1)
                    cv2.putText(frame, label, (x+2, y+12), self.font, 0.5, (255, 255, 255), 1)
        return frame
